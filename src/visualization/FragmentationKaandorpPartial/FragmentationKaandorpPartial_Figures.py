...
def run(scenario, figure_direc: str):
    ...
    #
    # timeseries.FragmentationKaandorpPartial_timeseries(scenario=scenario, figure_direc=figure_direc, shore_time=shore_time,
    ...
    FieldDataComp.FragmentationKaandorpPartial_FieldDataComp(figure_direc=figure_direc, scenario=scenario,
                                                             shore_time=shore_time, lambda_frag=388, density=rho)
